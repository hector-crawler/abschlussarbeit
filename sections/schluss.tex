...
\begin{itemize}
	...
	\item Der gesamte Entwicklungsprozess sowie die benötigte Entwicklungsumgebung sind gut dokumentiert und leicht zu verwalten. Dies für zukünftige Projekte den Projektanfang stark erleichtern.
...
Softwareseitig wäre der genauere Vergleich verschiedener Machine-Learning-\hspace{0px}Algorithmen interessant zu untersuchen, etwa zwischen dem existierenden Q-Learning-\hspace{0px}Algorithmus und einer Implementation eines neuronalen Netzwerks. Aufgrund der mangelnden \linebreak Verfügbarkeit der Motoren des Roboters konnte der Vergleich in der Zeit unseres Projekts nicht durchgeführt werden. Fernere Möglichkeit zur Weiterentwicklung wäre etwa eine automatische Steuerung von Versuchsreihen nach konfigurierbaren Parametern. 
